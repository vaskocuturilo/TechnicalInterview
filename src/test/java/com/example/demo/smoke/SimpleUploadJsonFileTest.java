...
public class SimpleUploadJsonFileTest extends BaseClass {
    File file = new File("src/main/resources/upload.json");

    @Description("This is simple automation script for upload json file.")
    @DisplayName("Simple upload json file automation script.")
    @Test
